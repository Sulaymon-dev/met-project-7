                ...
                <div class="col-sm-12">
                    <div class="card">
                        <form action="{{route('subjects.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="alert alert-danger ">baroi ilovai testi 4x1 avval plani darsi va nomi mabzuro intikhob namoed </div>
                            ...
                            <h4 id="quizTitle" class="text-center alert alert-info" style="display: none">Тестҳоро пурра кунед.</h4>
