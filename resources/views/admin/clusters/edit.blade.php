                    ...
                    <div class="card">
                        <form action="{{route('clusters.update',$cluster->id)}}" method="post">
                            ...
                            <div class="card-header">
                                Тағйироти <strong> кластер </strong>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" id="name"
                                           type="text" name="name" value="{{$cluster->name ?? old('name')}}">
                                    @error('name')
                                    <div class="invalid-feedback">Лутфан номи синфро ворид намоед</div>
                                    @enderror
                                </div>
